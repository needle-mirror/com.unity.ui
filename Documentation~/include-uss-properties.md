|Property|Syntax|Inherited|Description|
|-|-|-|-|
|[align-content](uss-properties-align-content.md)|<code>flex-start \| flex-end \| center \| stretch \| auto</code>|No|Alignment of the whole area of children on the cross axis if they span over multiple lines in this container.|
|[align-items](uss-properties-align-items.md)|<code>flex-start \| flex-end \| center \| stretch \| auto</code>|No|Alignment of children on the cross axis of this container.|
|[align-self](uss-properties-align-self.md)|<code>flex-start \| flex-end \| center \| stretch \| auto</code>|No|Similar to align-items, but only for this specific element.|
|[background-color](uss-properties-background-color.md)|<code>&lt;color&gt;</code>|No|Background color to paint in the element's box.|
|[background-image](uss-properties-background-image.md)|<code>&lt;resource&gt; \| &lt;url&gt; \| none</code>|No|Background image to paint in the element's box.|
|[border-bottom-color](uss-properties-border-color.md)|<code>&lt;color&gt;</code>|No|Color of the element's bottom border.|
|[border-bottom-left-radius](uss-properties-border-radius.md)|<code>&lt;length&gt; \| &lt;percentage&gt;</code>|No|The radius of the bottom-left corner when a rounded rectangle is drawn in the element's box.|
|[border-bottom-right-radius](uss-properties-border-radius.md)|<code>&lt;length&gt; \| &lt;percentage&gt;</code>|No|The radius of the bottom-right corner when a rounded rectangle is drawn in the element's box.|
|[border-bottom-width](uss-properties-border-width.md)|<code>&lt;length&gt;</code>|No|Space reserved for the bottom edge of the border during the layout phase.|
|[border-color](uss-properties-border-color.md)|<code>&lt;color&gt;{1,4}</code>|No|Shorthand for border-top-color, border-right-color, border-bottom-color, border-left-color|
|[border-left-color](uss-properties-border-color.md)|<code>&lt;color&gt;</code>|No|Color of the element's left border.|
|[border-left-width](uss-properties-border-width.md)|<code>&lt;length&gt;</code>|No|Space reserved for the left edge of the border during the layout phase.|
|[border-radius](uss-properties-border-radius.md)|<code>[ &lt;length&gt; \| &lt;percentage&gt; ]{1,4}</code>|No|Shorthand for border-top-left-radius, border-top-right-radius, border-bottom-right-radius, border-bottom-left-radius|
|[border-right-color](uss-properties-border-color.md)|<code>&lt;color&gt;</code>|No|Color of the element's right border.|
|[border-right-width](uss-properties-border-width.md)|<code>&lt;length&gt;</code>|No|Space reserved for the right edge of the border during the layout phase.|
|[border-top-color](uss-properties-border-color.md)|<code>&lt;color&gt;</code>|No|Color of the element's top border.|
|[border-top-left-radius](uss-properties-border-radius.md)|<code>&lt;length&gt; \| &lt;percentage&gt;</code>|No|The radius of the top-left corner when a rounded rectangle is drawn in the element's box.|
|[border-top-right-radius](uss-properties-border-radius.md)|<code>&lt;length&gt; \| &lt;percentage&gt;</code>|No|The radius of the top-right corner when a rounded rectangle is drawn in the element's box.|
|[border-top-width](uss-properties-border-width.md)|<code>&lt;length&gt;</code>|No|Space reserved for the top edge of the border during the layout phase.|
|[border-width](uss-properties-border-width.md)|<code>&lt;length&gt;{1,4}</code>|No|Shorthand for border-top-width, border-right-width, border-bottom-width, border-left-width|
|[bottom](uss-properties-bottom.md)|<code>&lt;length&gt; \| &lt;percentage&gt; \| auto</code>|No|Bottom distance from the element's box during layout.|
|[color](uss-properties-color.md)|<code>&lt;color&gt;</code>|Yes|Color to use when drawing the text of an element.|
|[cursor](uss-properties-cursor.md)|<code>[ [ &lt;resource&gt; \| &lt;url&gt; ] [ &lt;integer&gt; &lt;integer&gt; ]? ] \| [ arrow \| text \| resize-vertical \| resize-horizontal \| link \| slide-arrow \| resize-up-right \| resize-up-left \| move-arrow \| rotate-arrow \| scale-arrow \| arrow-plus \| arrow-minus \| pan \| orbit \| zoom \| fps \| split-resize-up-down \| split-resize-left-right ]</code>|No|Mouse cursor to display when the mouse pointer is over an element.|
|[display](uss-properties-display.md)|<code>flex \| none</code>|No|Defines how an element is displayed in the layout.|
|[flex](uss-properties-flex.md)|<code>none \| [ &lt;&#39;flex-grow&#39;&gt; &lt;&#39;flex-shrink&#39;&gt;? \|\| &lt;&#39;flex-basis&#39;&gt; ]</code>|No|Shorthand for flex-grow, flex-shrink, flex-basis|
|[flex-basis](uss-properties-flex.md)|<code>&lt;&#39;width&#39;&gt;</code>|No|Initial main size of a flex item, on the main flex axis. The final layout might be smaller or larger, according to the flex shrinking and growing determined by the other flex properties.|
|[flex-direction](uss-properties-flex-direction.md)|<code>column \| row \| column-reverse \| row-reverse</code>|No|Direction of the main axis to layout children in a container.|
|[flex-grow](uss-properties-flex.md)|<code>&lt;number&gt;</code>|No|Specifies how the item will shrink relative to the rest of the flexible items inside the same container.|
|[flex-shrink](uss-properties-flex.md)|<code>&lt;number&gt;</code>|No|Specifies how the item will shrink relative to the rest of the flexible items inside the same container.|
|[flex-wrap](uss-properties-flex-wrap.md)|<code>nowrap \| wrap \| wrap-reverse</code>|No|Placement of children over multiple lines if not enough space is available in this container.|
|[font-size](uss-properties-font-size.md)|<code>&lt;length&gt; \| &lt;percentage&gt;</code>|Yes|Font size to draw the element's text.|
|[height](uss-properties-width-and-height.md)|<code>&lt;length&gt; \| &lt;percentage&gt; \| auto</code>|No|Fixed height of an element for the layout.|
|[justify-content](uss-properties-justify-content.md)|<code>flex-start \| flex-end \| center \| space-between \| space-around</code>|No|Justification of children on the main axis of this container.|
|[left](uss-properties-left.md)|<code>&lt;length&gt; \| &lt;percentage&gt; \| auto</code>|No|Left distance from the element's box during layout.|
...
|[-unity-text-outline-color](uss-properties-unity-text-outline.md)|<code>&lt;color&gt;</code>|Yes|Outline color of the text.|
