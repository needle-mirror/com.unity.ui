    ...
    internal class StyleField : VisualElement
    {
        ...
        public void RefreshPropertyValue(object val, int specificity)
        {
            ...
            else if (val is Background bgValue)
            {
                ...
                if (!IsFocused(field))
                    field.SetValueWithoutNotify(bgValue.vectorImage != null ? (UnityEngine.Object)bgValue.vectorImage : (bgValue.sprite != null ? (UnityEngine.Object)bgValue.sprite : (UnityEngine.Object)bgValue.texture));
            }
