...
namespace Unity.UIElements.Editor.Samples
{
    ...
    {
        private static readonly string s_StyleSheetPath = "Packages/com.unity.ui/PackageResources/StyleSheets/UIElementsSamples/UIElementsSamples.uss";
        private static readonly string s_DarkStyleSheetPath = "Packages/com.unity.ui/PackageResources/StyleSheets/UIElementsSamples/UIElementsSamplesDark.uss";
        private static readonly string s_LightStyleSheetPath = "Packages/com.unity.ui/PackageResources/StyleSheets/UIElementsSamples/UIElementsSamplesLight.uss";
        ...
        [CommandHandler(nameof(OpenUIElementsSamplesCommand))]
        private static void OpenUIElementsSamplesCommand(CommandExecuteContext c)
        {
