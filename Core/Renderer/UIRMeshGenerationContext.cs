...
namespace UnityEngine.UIElements
{
    ...
    internal static class MeshGenerationContextUtils
    {
        ...
        public struct RectangleParams
        {
            ...
            public static RectangleParams MakeSprite(Rect rect, Sprite sprite, ScaleMode scaleMode, ContextType panelContext, out Vector4 slices)
            {
                var playmodeTintColor = panelContext == ContextType.Editor
                    ? UIElementsUtility.editorPlayModeTintColor
                    : Color.white;
                ...
                bool hasSlices = (border != Vector4.zero);
                bool useFullTexture = (scaleMode == ScaleMode.ScaleAndCrop) || hasSlices;
                ...
                slices = new Vector4(border.x, border.w, border.z, border.y);
